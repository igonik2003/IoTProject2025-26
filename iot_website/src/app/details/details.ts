...
export class Details implements OnInit{
  ...
  getGrafanaPanelUrl(piId: string,sensorId: string): string {
    if (piId==="pi2" && sensorId==="4sd"){
      ...
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-19&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi1" && sensorId==="dl"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-18&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi1" && sensorId==="dms"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-20&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi2" && sensorId==="dht3"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-11&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi2" && sensorId==="gsg"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-12&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi3" && sensorId==="dht1"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-13&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi3" && sensorId==="dth2"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-14&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi3" && sensorId==="ir"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-15&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi3" && sensorId==="brgb"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-16&__feature.dashboardSceneSolo=true";
    }
    else if(piId=="pi3" && sensorId==="lcd"){
      return "http://localhost:3000/d-solo/igslgxw/iot-project?orgId=1&from=1776613307397&to=1776634907397&timezone=browser&panelId=panel-17&__feature.dashboardSceneSolo=true";
    }
    return "";
  }
